...
internal class ServerInfoRetriever : IServerInfoRetriever
{
    ...
    public async Task<List<XServerInfo>> UpdateServerListAsync(XServerInfo serverInfo)
    {
        ...
        UpdateServerInfoRes updateRes = UpdateServerInfoRes.Parser.ParseFrom(res.Payload.Data);
        ...
        return updateRes.ServerInfos.Where(e=>e.Endpoint != serverInfo.BindEndpoint).Select(e=>XServerInfo.Of(e)).ToList();
    }
}