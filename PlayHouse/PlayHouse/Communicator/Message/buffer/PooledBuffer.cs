...
namespace PlayHouse.Communicator.Message.buffer
{
    /// <summary>
    /// Dynamic byte buffer
    /// </summary>
    public class PooledBuffer : IDisposable
    {
        ...
        public static void Init(long maxBufferPoolSize = 1024 * 1024 * 100)
        {
            _bufferManager = BufferManager.CreateBufferManager(maxBufferPoolSize, PacketParser.MAX_PACKET_SIZE);
        }
