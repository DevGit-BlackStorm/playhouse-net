...
namespace PlayHouseTests.Service.Api.plain
{
    ...
    public class ApiReflectionTest
    {
        ...
        public async Task Test_CALL_Method()
        {
            ...
            ReflectionTestResult.ResultMap[$"TestApiGlobalActionAttributeBefore_{ApiTestMsg1.Descriptor.Name}"].Should().Be("BeforeExecution");
            ReflectionTestResult.ResultMap[$"TestApiGlobalActionAttributeAfter_{ApiTestMsg1.Descriptor.Name}"].Should().Be("AfterExecution");

            ReflectionTestResult.ResultMap[$"TestApiActionAttributeBefore_{ApiTestMsg1.Descriptor.Name}"].Should().Be("BeforeExecution");
            ReflectionTestResult.ResultMap[$"TestApiActionAttributeAfter_{ApiTestMsg1.Descriptor.Name}"].Should().Be("AfterExecution");
            ReflectionTestResult.ResultMap[$"TestApiMethodActionAttributeBefore_{ApiTestMsg1.Descriptor.Name}"].Should().Be("BeforeExecution");
            ReflectionTestResult.ResultMap[$"TestApiMethodActionAttributeAfter_{ApiTestMsg1.Descriptor.Name}"].Should().Be("AfterExecution");
            

            routePacket = RoutePacket.ApiOf(RoutePacket.Of(new ApiTestMsg2() { TestMsg = "ApiServiceCall_Test2" }), false, isBackend);
            await apiReflections.CallMethodAsync(routePacket.ToContentsPacket(), apiSender);

            ReflectionTestResult.ResultMap[$"TestApiGlobalActionAttributeBefore_{ApiTestMsg2.Descriptor.Name}"].Should().Be("BeforeExecution");
            ReflectionTestResult.ResultMap[$"TestApiGlobalActionAttributeAfter_{ApiTestMsg2.Descriptor.Name}"].Should().Be("AfterExecution");

            ReflectionTestResult.ResultMap["TestApiController_Test2"].Should().Be("ApiServiceCall_Test2");
            ReflectionTestResult.ResultMap[$"TestApiActionAttributeBefore_{ApiTestMsg2.Descriptor.Name}"].Should().Be("BeforeExecution");
            ReflectionTestResult.ResultMap[$"TestApiActionAttributeAfter_{ApiTestMsg2.Descriptor.Name}"].Should().Be("AfterExecution");
            ReflectionTestResult.ResultMap.ContainsKey($"TestApiMethodActionAttributeBefore_{ApiTestMsg2.Descriptor.Name}").Should().BeFalse();
            ReflectionTestResult.ResultMap.ContainsKey($"TestApiMethodActionAttributeAfter_{ApiTestMsg2.Descriptor.Name}").Should().BeFalse();
        ...
        public async Task Test_CALL_Backend_Method()
        {
            ...
            ReflectionTestResult.ResultMap[$"TestBackendApiActionAttributeBefore_{ApiTestMsg1.Descriptor.Name}"].Should().Be("BeforeExecution");
            ReflectionTestResult.ResultMap[$"TestBackendApiActionAttributeAfter_{ApiTestMsg1.Descriptor.Name}"].Should().Be("AfterExecution");
            ReflectionTestResult.ResultMap[$"TestBackendApiMethodActionAttributeBefore_{ApiTestMsg1.Descriptor.Name}"].Should().Be("BeforeExecution");
            ReflectionTestResult.ResultMap[$"TestBackendApiMethodActionAttributeAfter_{ApiTestMsg1.Descriptor.Name}"].Should().Be("AfterExecution");
            ...
            ReflectionTestResult.ResultMap[$"TestBackendApiActionAttributeBefore_{ApiTestMsg2.Descriptor.Name}"].Should().Be("BeforeExecution");
            ReflectionTestResult.ResultMap[$"TestBackendApiActionAttributeAfter_{ApiTestMsg2.Descriptor.Name}"].Should().Be("AfterExecution");
            ReflectionTestResult.ResultMap.ContainsKey($"TestBackendApiMethodActionAttributeBefore_{ApiTestMsg2.Descriptor.Name}").Should().BeFalse();
            ReflectionTestResult.ResultMap.ContainsKey($"TestBackendApiMethodActionAttributeAfter_{ApiTestMsg2.Descriptor.Name}").Should().BeFalse();
        }
