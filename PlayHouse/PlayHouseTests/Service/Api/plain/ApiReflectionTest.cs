...
internal class ReflectionTestResult
{
...
public class ApiReflectionTest
{
    ...
    public async Task Test_CALL_Method()
    {
        ...
        var controllAspectifyManager = new ApiControllAspectifyManager();
        ...
        var routePacket = RoutePacket.ApiOf(RoutePacket.Of(new ApiTestMsg1 { TestMsg = "ApiServiceCall_Test1" }), false,
            isBackend);
        ...
        routePacket = RoutePacket.ApiOf(RoutePacket.Of(new ApiTestMsg2 { TestMsg = "ApiServiceCall_Test2" }), false,
            isBackend);
        await apiReflections.CallMethodAsync(routePacket.ToContentsPacket(), apiSender);
    ...
    public async Task Test_CALL_Backend_Method()
    {
        ...
        var apiReflections =
            new ApiReflection(serviceCollection.BuildServiceProvider(), new ApiControllAspectifyManager());

        var apiSender = new Mock<IApiBackendSender>().Object;
        var isBackend = false;

        var routePacket = RoutePacket.ApiOf(RoutePacket.Of(new ApiTestMsg1 { TestMsg = "ApiBackendServiceCall_Test1" }),
            false, isBackend);
        ...
        routePacket = RoutePacket.ApiOf(RoutePacket.Of(new ApiTestMsg2 { TestMsg = "ApiBackendServiceCall_Test2" }),
            false, isBackend);
    ...
    public async Task SystemController_method_should_be_called()
    {
        ...
        await systemReflection.CallMethodAsync(new TestPacket(new SystemHandlerTestMsg { TestMsg = "SystemMethod" }),
            systemPanel, sender);
